...
export function Research() {
  ...
  async function submit(e: FormEvent<HTMLFormElement>) {
    ...
    const body: Record<string, unknown> = {
      ...
      slippage:         Number(fd.get('slippage') ?? 0.0005),
      stop_loss:        fd.get('stop_loss') ? Number(fd.get('stop_loss')) : undefined,
      take_profit:      fd.get('take_profit') ? Number(fd.get('take_profit')) : undefined,
      ...
      train_bars:       analysis.trainBars,
      test_bars:        analysis.testBars,
      run_monte_carlo:  analysis.runMonteCarlo,
      n_simulations:    analysis.nSimulations,
      run_robustness:   analysis.runRobustness,
      neighbor_steps:   analysis.neighborSteps,
